    ...
    $(function() { 
        ...
        $("#num").droppable({
          drop: function( event, ui ) {
            $("#num").val($("#memoria").text()); 
          }
        });
    

        $("#toM").click(function () {
          $("#memoria").text($("#num").val());
        });
        ...
        // Operaciones binarias
          $("#mas").on("click",   function() { acc = num.val();  op = "+"; vaciar(); num.val("+"); });
          $("#menos").on("click", function() { acc = num.val();  op = "-"; vaciar(); num.val("-"); });
          $("#X").on("click",     function() { acc = num.val();  op = "x"; vaciar(); num.val("×"); });
          $("#div").on("click",   function() { acc = num.val();  op = "d"; vaciar(); num.val("÷"); });
          $("#pot").on("click",   function() { acc = num.val();  op = "p"; vaciar(); num.val("^"); });
